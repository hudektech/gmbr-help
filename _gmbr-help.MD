...
By far the simplest way to use this extension is to leave the "link" field blank. Create your rows of rooms, give each room a unique name and then clickon the save button. The extension will create the links for you.
